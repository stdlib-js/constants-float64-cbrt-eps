...
```javascript
import CBRT_EPS from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-cbrt-eps@v0.2.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/constants-float64-cbrt-eps/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/constants-float64-cbrt-eps/actions/workflows/test.yml?query=branch:v0.2.0
